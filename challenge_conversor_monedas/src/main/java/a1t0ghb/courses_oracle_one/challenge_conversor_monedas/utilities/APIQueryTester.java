...
public class APIQueryTester {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println("-");
        // my_api_query.GetCurrencyData("my_api_token", "my_currency_from");       //  HTTP response: 404 (Page not found). Server didn't find a page, a returns a page for 'broken / dead links'.
